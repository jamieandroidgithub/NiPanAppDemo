...
//        TextView tv = new TextView(context);
        View tv = LayoutInflater.from(context).inflate(R.layout.item_wheel_layout,null);

        tv.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        TextView textView = (TextView) tv.findViewById(R.id.text_view);
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            TextView itemView = (TextView) view.findViewById(R.id.text_view);
            if (null == itemView) {
                return;
            }
            if (position == i) {
                itemView.setTextColor(getResources().getColor(R.color.accent1));
            } else {
